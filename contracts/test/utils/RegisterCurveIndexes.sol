...
contract RegisterCurveIndexes {
    ...
    address[] STETH_POOL_COINS = [ETH_ADDRESS, STETH_ADDRESS];
    bool constant STETH_POOL_SUPPORT_GET_DX = false;
    ...
    function _registerCurveIndexes(PermanentStorage pm) internal {
        ...
        // register stETH pool
        pm.setCurvePoolInfo(CURVE_STETH_POOL_ADDRESS, new address[](0), STETH_POOL_COINS, STETH_POOL_SUPPORT_GET_DX);
    }
}
