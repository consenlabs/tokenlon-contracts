...
interface IRFQ {
    ...
    /// @dev This event is emitted when an RFQ offer is filled with all necessary details.
    ...
    /// @dev This event is emitted when an RFQ offer is canceled by the maker.
    ...
    /// @dev This function allows a user to fill an RFQ offer based on the provided transaction details.
    ...
    /// @dev This function allows a user to fill an RFQ offer using a taker's cryptographic signature.
    /// @param rfqTx The RFQ transaction details.
    /// @param makerSignature The signature of the maker authorizing the fill.
    /// @param makerTokenPermit The permit for spending maker's tokens.
    /// @param takerTokenPermit The permit for spending taker's tokens.
    ...
    /// @dev This function allows the maker of an RFQ offer to cancel it.
