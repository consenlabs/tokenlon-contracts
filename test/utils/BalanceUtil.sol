...
contract BalanceUtil is Test {
    ...
    function externalDeal(address tokenAddr, address userAddr, uint256 amountInWei, bool updateTotalSupply) public {
    ...
    function setERC20Balance(address token, address user, uint256 amount) internal {
