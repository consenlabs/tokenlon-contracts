...
contract BalanceUtil is Addresses {
    ...
    function setERC20Balance(address tokenAddr, address userAddr, uint256 amount) internal {
    ...
    function approveERC20(IERC20[] memory tokens, address userAddr, address target) internal {
